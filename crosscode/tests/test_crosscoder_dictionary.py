...
class TestCrosscoderDictionaryWrapper(unittest.TestCase):
    def setUp(self):
        ...
        activation_fn = BatchTopkActivation(k_per_example=2)
    ...
    def test_encode_shape(self):
        dummy_input = torch.randn(self.b, self.n_models, self.n_hookpoints, self.d_model)
    ...
    def test_encode_feat_subset(self):
        ...
        self.assertTrue(torch.allclose(subset_latents, full_latents[:, feat_list], atol=1e-5))

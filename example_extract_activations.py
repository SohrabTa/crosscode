...
def extract_activations(
    model: T5EncoderModel, tokenizer: T5Tokenizer, sequences: list[str], device: torch.device
) -> torch.Tensor:
...
def main() -> None:
    ...
    parser.add_argument(
        "--input", type=str, default="dataset/uniref50_3M_length_512.fasta", help="Input FASTA file path."
    )
    parser.add_argument("--output", type=str, default="random_protein_activations.pt", help="Output file path.")

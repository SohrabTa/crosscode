...
5. **Training Run**: Successfully ran a training run with the following [Training Run Config](#training-run-config).
...
data:
  token_sequence_loader:
    type: "fasta"
    fasta_path: "/workspace/data/dataset/uniref50_3M_length_512.fasta"
